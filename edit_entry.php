...
<body>
  ...
  <form action="update_entry.php" method="post">
    ...
    <label>Affidavit: <input type="text" name="affidavit" value="<?= $entry['affidavit'] ?>" maxlength="1"></label><br>
    ...
    <label>Expenses: <input type="text" id="expenses" name="expenses" value="<?= $entry['expenses'] ?>" oninput="updateRemaining()"></label><br>
    <label>Advance: <input type="text" id="advance" name="advance" value="<?= $entry['advance'] ?>" oninput="updateRemaining()"></label><br>
    <label>Remaining: <input type="text" id="remaining" name="remaining" value="<?= $entry['remaining'] ?>" readonly></label><br>
    ...
    <div id="village-groups">
      <?php foreach ($grouped_lands as $groupKey => $lands): ?>
        ...
        <div id="<?= $groupId ?>">
          ...
          <label>Pargana/Tehsil/District: <input type="text" name="pargana_tehsil_district[]" value="<?= $pargana ?>"></label>
          <div id="<?= $groupId ?>">
